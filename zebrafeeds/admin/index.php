...
<!DOCTYPE html>
	...
	<div id="top">
<div class="normaltext"><a href="http://cazalet.org/zebrafeeds"><img src="../res/img/logo_admin.png" alt="ZebraFeeds"/></a></div>
       <div class="normaltext">administration panel :: <?php echo '<a href="../..">View website</a> - <a href="', $_SERVER['PHP_SELF'] , '?zfaction=logout';?>">Logout</a></div>
	</div>
<div id="header">
			<ul class="tabs">
		<?php
